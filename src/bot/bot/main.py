...
handler = ConversationHandler(
    ...
    states={
        ...
        S.START: [CommandHandler('start', start),
                  ...
                  MessageHandler(Filters.regex('^(' + KB.manu['uz'][3] + ')$'), settings),
                  ...
                  MessageHandler(Filters.regex('^(' + KB.manu['ru'][3] + ')$'), settings),
                  ...
                  MessageHandler(Filters.regex('^(' + KB.manu['en'][3] + ')$'), settings),
                  ],
