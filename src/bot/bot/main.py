...
handler = ConversationHandler(
    ...
    states={
        ...
        S.START: [CommandHandler('start', start),
                  CommandHandler('admin', admin),
                  CommandHandler('leader', leader),
                  MessageHandler(Filters.regex('^(' + KB.manu['uz'][0] + ')$'), k_fuel_type),
                  MessageHandler(Filters.regex('^(' + KB.manu['uz'][1] + ')$'), k_sale_fuel),
                  MessageHandler(Filters.regex('^(' + KB.manu['uz'][2] + ')$'), k_add_fuel_price_today),
                  MessageHandler(Filters.regex('^(' + KB.manu['uz'][3] + ')$'), k_settings),

                  MessageHandler(Filters.regex('^(' + KB.manu['ru'][0] + ')$'), k_fuel_type),
                  MessageHandler(Filters.regex('^(' + KB.manu['ru'][1] + ')$'), k_sale_fuel),
                  MessageHandler(Filters.regex('^(' + KB.manu['ru'][2] + ')$'), k_add_fuel_price_today),
                  MessageHandler(Filters.regex('^(' + KB.manu['ru'][3] + ')$'), k_settings),

                  MessageHandler(Filters.regex('^(' + KB.manu['en'][0] + ')$'), k_fuel_type),
                  MessageHandler(Filters.regex('^(' + KB.manu['en'][1] + ')$'), k_sale_fuel),
                  MessageHandler(Filters.regex('^(' + KB.manu['en'][2] + ')$'), k_add_fuel_price_today),
                  MessageHandler(Filters.regex('^(' + KB.manu['en'][3] + ')$'), k_settings),
                  ],
