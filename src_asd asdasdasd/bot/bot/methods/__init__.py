try:
    from .base import (start, k_fuel_column, k_choose_column, k_change_column_first, k_fuel_type, k_get_fuel_type,
                       ...
                       k_fuel_column_sale, k_fuel_sale, k_add_fuel_price_today, k_fuel_type_price, k_input_fuel_price, k_settings, k_change_language, k_get_lang)
    from .leader import leader, input_fuel, input_fuel_type
    ...
    from base import (start, k_fuel_column, k_choose_column, k_change_column_first, k_fuel_type, k_get_fuel_type,
                      ...
                      k_sale_fuel_type, k_fuel_column_sale, k_fuel_sale, k_add_fuel_price_today, k_fuel_type_price, k_input_fuel_price, k_settings, k_change_language, k_get_lang)
    from leader import leader, input_fuel, input_fuel_type
